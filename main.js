...
const ingredientsData = {
   ...
   'beef-wellington': {
      ...
      ingredients: [
         ...
         {
            name: 'عجينة مورقة (بف باستري)',
            allergen: true
         },
         {
            name: 'حشوة مشروم مفروم (دوكسيل)',
            allergen: false
         },
         {
            name: 'بروسكيوتو',
   ...
   if (dish) {
      ...
      dish.ingredients.forEach(ingredient => {
         ...
         li.innerHTML = `
                        ...
                        ${ingredient.allergen ? '<span class="allergen"> قد تسبب حساسية </span>' : ''}
                    `;
         list.appendChild(li);
      });
...
function handleReservation(e) {
   ...
   alert(`شكرا , ${reservation.name}! حجزك لعدد افراد ${reservation.guests} تم تسجيلة فى  ${reservation.date} الساعة ${reservation.time} . سنرسل لك تاكيد الحجز كرسالة على ايميلك الخاص ${reservation.email}.`);
